...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
	return (
		<InputPrimitive
			type={type}
			data-slot="input"
			// The app's inputs take technical terms (e.g. "Pulumi", "kubectl"),
			// so disable the WebView's autocorrect/capitalize/spellcheck by
			// default. Callers can still override via props.
			autoCorrect="off"
			autoCapitalize="off"
			spellCheck={false}
			{...props}
